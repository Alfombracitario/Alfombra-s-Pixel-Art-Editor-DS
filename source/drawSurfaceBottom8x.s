...
.global drawSurfaceBottom8x
.type drawSurfaceBottom8x, %function
drawSurfaceBottom8x:
    @ Entradas:
    ...
    mov     r7, #16          @ r7 = contador de filas
...
inner_x_loop:
    ...
    mov     r6, #7           @ r6 = contador de copias verticales
...
copy_loop: @funciona
    ...
    add     r1, r1, #4096  @ dstBase += 4 * dstStride (avanzar 8 filas)
