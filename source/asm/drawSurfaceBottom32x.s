...
.global drawSurfaceBottom32x
.type drawSurfaceBottom32x, %function
drawSurfaceBottom32x:
    push    {r4-r11, lr}

    mov     r7, #4          @ r7 = contador de filas
...
inner_x_loop:
    ...
    strh    r8, [r12], #2    @ 17ª copia
    strh    r8, [r12], #2    @ 18ª copia
    strh    r8, [r12], #2    @ 19ª copia
    strh    r8, [r12], #2    @ 20ª copia
    strh    r8, [r12], #2    @ 21ª copia
    strh    r8, [r12], #2    @ 22ª copia
    strh    r8, [r12], #2    @ 23ª copia
    strh    r8, [r12], #2    @ 24ª copia
    strh    r8, [r12], #2    @ 25ª copia
    strh    r8, [r12], #2    @ 26ª copia
    strh    r8, [r12], #2    @ 27ª copia
    strh    r8, [r12], #2    @ 28ª copia
    strh    r8, [r12], #2    @ 29ª copia
    strh    r8, [r12], #2    @ 30ª copia
    strh    r8, [r12], #2    @ 31ª copia
    strh    r8, [r12], #2    @ 32ª copia
    subs r6, #1
    bne inner_x_loop
    ...
    mov     r6, #31           @ r6 = contador de copias verticales
...
copy_loop: @funciona
    ...
    add     r1, r1, #16384  @ (avanzar 16 filas)
